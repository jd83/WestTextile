						 ...
						 <div class="register-bottom-grid" id="divShopInfo" style="display: none">
							 <span>增加商铺<input type="button" value="+" onclick="addShopInfo();"/>&nbsp&nbsp删除商铺<input type="button" value="-" onclick="removeShopInfo(this.parentNode.parentNode);"/></span>
								 <div class="wow fadeInLeft" data-wow-delay="0.4s">
									...
									<input type="text" name="shop.shopname"  value="<s:property value='#shop.shopname'/>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '格式：x-x-x';}"> 
								 </div>
								 <div class="wow fadeInRight" data-wow-delay="0.4s">
								 ...
								 <div class="wow fadeInLeft" data-wow-delay="0.4s">
									...
									<input type="text" name="shop.shopsquare" value="<s:property value='#shop.shopsquare'/>"/> 
								 </div>
								 <div class="wow fadeInRight" data-wow-delay="0.4s">
									<span>商铺总价<label>*</label></span>
									<input type="text" name="shop.shopamount" value="<s:property value='#shop.shopamount'/>"/>
								 </div>
						 </div>
					</s:iterator> 
				  </div>
