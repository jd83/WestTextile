...
public final class registration_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"username\" value=\"a\"/> \r\n");
      out.write("\t\t\t\t\t </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>经营权<input type=\"radio\" name=\"shoptype\" value=\"经营权\"/>&nbsp&nbsp&nbsp&nbsp</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"identityid\"> \r\n");
      out.write("\t\t\t\t\t\t </div>\r\n");
      out.write("\t\t\t\t\t\t <div class=\"wow fadeInRight\" data-wow-delay=\"0.4s\">\r\n");
      out.write("\t\t\t\t\t\t\t<span>QQ号码</span>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\"  name=\"qqnumber\">\r\n");
      out.write("\t\t\t\t\t\t </div>\r\n");
      out.write("\t\t\t\t\t\t <div class=\"wow fadeInLeft\" data-wow-delay=\"0.4s\">\r\n");
