...
public final class registration_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\tdivShopInfo.setAttribute(\"style\",\"display: block;\");\r\n");
      out.write("\t\t\tvar top=document.getElementById(\"divShopInfoAuto\");\r\n");
      out.write("\t\t\tvar divShopInfoCnt=top.childNodes.length;\r\n");
      out.write("\t\t\tdivShopInfo.id=\"divShopInfo\"+(divShopInfoCnt-1);\r\n");
      out.write("\t\t\ttop.appendChild(divShopInfo);\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tfunction removeShopInfo(){\r\n");
      out.write("\t\t\tvar top=document.getElementById(\"divShopInfoAuto\");\r\n");
      out.write("\t\t\tvar divShopInfoCnt=top.childNodes.length;\r\n");
      out.write("\t\t\ttop.removeChild(0);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t</script>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"about.html\">XX查询</a></li>\r\n");
      ...
      out.write("\t\t\t\t\t\t <label class=\"checkbox\"><input type=\"checkbox\" id=\"chkShopInfo\" onclick=\"showChkInfo(this,'divShopInfoAuto');\"><i> </i>验证XX信息</label>\r\n");
      out.write("\t\t\t\t\t   </a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t <div class=\"register-bottom-grid\" id=\"divShopInfoAuto\" style=\"display: none\">\r\n");
      out.write("\t\t\t\t\t<span>增加商铺<input type=\"button\" value=\"+\" onclick=\"addShopInfo();\"/></span>\r\n");
      out.write("\t\t\t\t\t<span>删除商铺<input type=\"button\" value=\"-\" onclick=\"removeShopInfo();\"/></span>\r\n");
      out.write("\t\t\t\t </div>\r\n");
      out.write("\t\t\t\t <div class=\"register-bottom-grid\" id=\"divShopInfo\" style=\"display: none\">\r\n");
      out.write("\t\t\t\t\t\t <div class=\"wow fadeInLeft\" data-wow-delay=\"0.4s\">\r\n");
      out.write("\t\t\t\t\t\t\t<span>商铺号<label>*</label></span>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"shop_name\"  value=\"格式：x-x-x\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = '格式：x-x-x';}\"> \r\n");
      out.write("\t\t\t\t\t\t </div>\r\n");
      out.write("\t\t\t\t\t\t <div class=\"wow fadeInRight\" data-wow-delay=\"0.4s\">\r\n");
      out.write("\t\t\t\t\t\t\t<span>商铺类型<label>*</label></span>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" value=\"经营权或产权\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = '经营权或产权';}\">\r\n");
      out.write("\t\t\t\t\t\t </div>\r\n");
      out.write("\t\t\t\t\t\t <div class=\"wow fadeInLeft\" data-wow-delay=\"0.4s\">\r\n");
