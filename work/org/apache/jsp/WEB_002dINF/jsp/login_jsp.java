 ...
 * Generated at: 2015-02-14 17:14:01 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t  \t  <div class=\"login-top-grid\" style=\"display: inline-block;height:100%;width:100%;margin:0px\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"userWithBLOBs.username\" size=\"60%\"/> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t </div>\t\t\t\t\t  \t  \t\r\n");
      out.write("\t\t\t\t\t\t  \t  \t</td></tr>\r\n");
      out.write("\t\t\t\t\t\t  \t  \t<tr><td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t <div class=\"wow fadeInLeft\" data-wow-delay=\"0.4s\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span>密码<label>*</label></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"userWithBLOBs.password\" size=\"60%\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t </div>\t\t\t\t  \t  \t\r\n");
      out.write("\t\t\t\t\t\t  \t  \t</td></tr>\t\t\t\t  \t  \t\r\n");
      out.write("\t\t\t\t\t  \t  \t</table>\r\n");
      out.write("\t\t\t\t\t  \t  </div>\r\n");
